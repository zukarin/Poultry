...
<section id="filters" class="section-p1 fix">
    ...
    function applyFilters() {
        ...
        window.location.href = "./home_shop_user.php?brand=" + selectedBrand + "&category=" + selectedCategory;    
    }
...
<!-- product(it is random unless filtered) -->
  ...
  <script>
      function openProductDetails(productId) {
          ...
          window.location.href = `./home_shop_user.php?product_id=${productId}`;
      }
...
// SQL query to retrieve all products without filtering by brand or category
$select_query = "SELECT products.*, brands.brand_title
                FROM products
                LEFT JOIN brands ON products.brand_id = brands.brand_id";
...
<script src="./home_shop_user.js"></script>
