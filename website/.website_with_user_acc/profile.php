...
<head>
    ...
    <link rel="stylesheet" href="./profile.css"> <!-- Include your stylesheet -->
    ...
    .profile-container {
        ...
        border-radius: 8px;
        box-shadow: 0 0.2rem 0.5rem rgba(10, 10, 10, 10.1);
        padding: 20px;
        width: 400px;
        text-align: center;
    }
...
<div class="profile-container profile-table" >
    <h2>User Profile</h2>
    <p>Username: <?php echo $user_data['username']; ?></p>
    <p>Email: <?php echo $user_data['email']; ?></p>
    <p>Shipping Address: <?php echo $user_data['adress']; ?></p>
    <p>Phone Number: <?php echo $user_data['phone_number']; ?></p>
    <p>Birthdate: <?php echo $user_data['birthdate']; ?></p>
    <p>Gender: <?php echo $user_data['gender']; ?></p>

    <!-- Add an edit button that links to the edit profile page -->
    <a href="edit_profile.php?email=<?php echo $user_data['email']; ?>">Edit Profile</a>
</div>
<div class="profile-container profile-table" >
<button class="btn btn-primary btn-block" onclick="window.location.href='order_history.php'">Show orders</button>   
</div>
