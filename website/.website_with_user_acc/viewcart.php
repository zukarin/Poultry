...
<section class="table">
    ...
    <table class="custom-table">
      ...
      $select_products = "SELECT products.*, brands.brand_title 
        ...
        // $select_products = "SELECT * FROM products where product_id = $key";
        $result = mysqli_query($connection, $select_products);
        $row = mysqli_fetch_assoc($result);
        ...
        <tr>
        <td><img width='50' src="../admin/product_images/<?php echo $row['product_image1']; ?>" alt="Product Image"></td>

            <td><?php echo $row['product_title'] . ' (' . $row['brand_title'] . ')' ?></td>
        ...
        <tr>
            <td colspan="3"><strong>Total Quantity/Price</strong></td>
