...
<form action="" method="post" class="mb-2">
    <div class="input-group w-90 mb-2">
        ...
        <input type="text" class="form-control" name="brand_title" placeholder="Insert Breed" aria-level="brands" aria-describedby="basic-addon1">
    </div>

   <div class="input-group w-10 mb-2">
        <input type="submit" class="bg-info" name="insert_brand" value="Insert Breed" aria-level="Username" aria-describedby="basic-addon1">
    </div>
    <!-- <div class="input-group w-10 mb-2">
        <button type="submit" class="btn btn-info" name="insert_cat">Insert Brands</button>
    </div> -->
</form>
